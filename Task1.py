...
L1=Label(root, text='My To Do List', bg='sky blue', font=("Times", 15), wraplength=300)
L1.place(x=90, y=10)
tasks = Listbox(root, selectbackground='grey', bg='pink', font=('verdana', 12), height=12, width=25)
